...
#Define custom_notation_limit here if notation == "custom" but no limit is set
custom_notation_limit = 1
...
def create_settings_window():
    try:
        ...
        Label(settings_window, font=("TkDefaultFont"), text="").pack()
        ratingbutton = Button(settings_window, text="Zu numerischer Bewertung wechseln", command=switch)
        ratingbutton.pack()
        Label(settings_window, font=("TkDefaultFont"), text="").pack()
        Button(settings_window, font=("TKDefaultFont"), text="Bewertungstext ändern", command=create_rating_edit_window).pack()
        Label(settings_window, font=("TkDefaultFont"), text="").pack()
        Label(settings_window, font=("TkDefaultFont"), text="").pack()
...
def switch():
    ...
    try:
        if rating == "numerical":
            rating = "letter"
            ratingbutton.config(text="Zu numerischer Bewertung wechseln")
        elif rating == "letter":
            rating = "numerical"
            ratingbutton.config(text="Zu alphabetischer Bewertung wechseln")
    except Exception as e:
        print(f"Error (Code E003): {e}")
        messagebox.showerror(f"Error (Code E003)", "Ein unerwarteter Fehler ist aufgetreten.")
...
def update_sliders():
    ...
    slider1 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider1.pack()
    slider1.set(3)
    ...
    slider2 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider2.pack()
    slider2.set(3)
    ...
    slider3 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider3.pack()
    slider3.set(3)
    ...
    slider4 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider4.pack()
    slider4.set(3)
    ...
    slider5 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider5.pack()
    slider5.set(3)
    ...
    slider6 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider6.pack()
    slider6.set(3)
    ...
    slider7 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider7.pack()
    slider7.set(3)
    ...
    slider8 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider8.pack()
    slider8.set(3)
    ...
    slider9 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider9.pack()
    slider9.set(3)
    ...
    slider10 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider10.pack()
    slider10.set(3)
    ...
    slider11 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider11.pack()
    slider11.set(3)
    ...
    slider12 = Scale(frame, from_=0, to=custom_notation_limit, width=15, length=625,orient=HORIZONTAL)
    slider12.pack()
    slider12.set(3)
...
def create_rating_edit_window():
    try:
        global notationswitchbutton, notation, custom_notation_entry
        notation = "school"
        rating_edit_window = Toplevel(mainWindow)
        rating_edit_window.title("Bewertung bearbeiten")
        rating_edit_window.geometry("400x350")
        rating_edit_window.resizable(False, False)

        Label(rating_edit_window, font=("TkDefaultFont", 21), text="Bewertung bearbeiten").pack()
        Label(rating_edit_window, font=("TkDefaultFont"), text="").pack()

        notationswitchbutton = Button(rating_edit_window, font=("TkDefaultFont"), text="Zu eigener Notation wechseln", command=switch_notation)
        notationswitchbutton.pack()

        Label(rating_edit_window, font=("TkDefaultFont"), text="").pack()
        Label(rating_edit_window, font=("TkDefaultFont"), text="Falls Sie eigene Notation ausgewählt haben, \nkönnen Sie hier nun die maximale Anzahl der Punkte angeben.\nDie Punktenotation beginnt immer bei 0.\n\nBeispiel: Bei einer Eingabe von 20 schaltet \ndie Skala auf 0-20 Punkte.").pack()
        Label(rating_edit_window, font=("TkDefaultFont"), text="").pack()
        custom_notation_entry = Text(rating_edit_window, font="TkDefaultFont", height=1, width=5, blockcursor=False)
        custom_notation_entry.pack()
        customnotationsavebutton = Button(rating_edit_window, font=("TkDefaultFont"), text="Speichern", command=set_custom_notation_limit)
        customnotationsavebutton.pack()
        Label(rating_edit_window, font=("TkDefaultFont"), text="").pack()
        Label(rating_edit_window, font=("TkDefaultFont"), text="Notationen in 5er- oder 10erschritten \nwerden in Kürze implementiert.").pack()
    except Exception as e:
        print(f"Error (Code E003): {e}")
        messagebox.showerror(f"Error (Code E003)", "Ein unerwarteter Fehler ist aufgetreten.")
...
def switch_notation():
    ...
    try:
        if notation == "school":
            notation = "custom"
            notationswitchbutton.config(text="Zu Schulnotation wechseln")
        elif notation == "custom":
            notation = "school"
            notationswitchbutton.config(text="Zu eigener Notation wechseln")
    except Exception as e:
        print(f"Error (Code E003): {e}")
        messagebox.showerror(f"Error (Code E003)", "Ein unerwarteter Fehler ist aufgetreten.")

def set_custom_notation_limit():
    global custom_notation_limit
    try:
        custom_notation_limit = int(custom_notation_entry.get("1.0", "end--1c"))
    except ValueError:
        print(f"Error (Code E006): ValueError (Invalid input)")
        messagebox.showerror("Error (Code E006)", "Bitte geben Sie einen gültigen Integer (Keine Kommazahl) ein.")
    except Exception as e:
        print(f"Error (Code E003): {e}")
        messagebox.showerror(f"Error (Code E003)", "Ein unerwarteter Fehler ist aufgetreten.")
...
def create_output():
    try: 
        ...
        with open(output_file_name, "w") as output_file_create: 
            ...
            elif rating == "numerical":
                for i in range(12):
                    if slider_inputvar[i] != 0: 
                        output_file_create.write("<div class='criteria'><p>" + globals()[f'ruleset_preview_{i + 1}'] + "</p></div>\n") 
                        if slider_inputvar[i] == 1: 
                            output_file_create.write("<div class='rating'><p>1</p></div>\n") 
                        elif slider_inputvar[i] == 2: 
                            output_file_create.write("<div class='rating'><p>2</p></div>\n") 
                        elif slider_inputvar[i] == 3: 
                            output_file_create.write("<div class='rating'><p>3</p></div>\n") 
                        elif slider_inputvar[i] == 4: 
                            output_file_create.write("<div class='rating'><p>4</p></div>\n") 
                        elif slider_inputvar[i] == 5: 
                            output_file_create.write("<div class='rating'><p>5</p></div>\n") 
                    output_file_create.write("\n")
